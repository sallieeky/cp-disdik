...
(function ($) {
    ...
    var methods = {
            ...
            var menuItems = {
                                    ...
                                    palette.append(
                                        $("<li />")
                                            ...
                                            .click(function () {
                                                ...
                                                methods.restoreSelection.apply(
                                                    this
                                                );
                                                methods.setStyleWithCSS.apply(
                                                    this
                                                );
                    ...
                    onSave: function () {
                        ...
                        if (
                            ...
                            var targetLink =
                                ...
                                targetText +
                                "</a>";
                            methods.restoreSelection.apply(editorObj, [
                                targetLink,
                                "html",
                            ]);
                        } else {
                ...
                insert_table: {
                    ...
                    onSave: function () {
                        ...
                        var tblCellspacing = $(
                            "#tblCellspacing" + _idSuffix
                        ).val();
                        var tblCellpadding = $(
                            "#tblCellpadding" + _idSuffix
                        ).val();
                        var intReg = /^[0-9]+$/;
                        var cssReg =
                                    ...
                                    $("<li />")
                                        ...
                                        .click(function (event) {
                                            if (
                                                ...
                                                var specCharHtml =
                                                    $(this).html();
                                                methods.insertTextAtSelection.apply(
                                                    this,
                                                    [specCharHtml, "html"]
                                                );
                                            } else {
        ...
        createImageContext: function (event, cMenuUl) {
            ...
            var imgModalBody = methods.imageAttributeWidget.apply(this, [
                "edit",
            ]);
            var onSave = function () {
                var urlPattern =
            ...
            var modalTrigger = $("<a/>", {
                ...
                (function (e) {
                    return function () {
                        ...
                        $("#imgAlt").val(
                            $(e.target).closest("img").attr("alt")
                        );
                        $("#imgTarget").val("");

                        if (
                            typeof $(e.target).closest("img").attr("id") !==
                            "undefined"
                        ) {
        ...
        createTableContext: function (event, cMenuUl) {
            ...
            var onSave = function () {
                ...
                if (
                    tblCellspacingEdt != "" &&
                    !tblCellspacingEdt.match(tblEdtNumReg)
                ) {
                    methods.showMessage.apply(this, [
                        "tblErrMsgEdt",
                        "Cell spacing must be a positive number",
                ...
                if (
                    tblCellpaddingEdt != "" &&
                    !tblCellpaddingEdt.match(tblEdtNumReg)
                ) {
                    methods.showMessage.apply(this, [
                        "tblErrMsgEdt",
                        "Cell padding must be a positive number",
                ...
                (function (e) {
                    return function () {
                        ...
                        $("#tblColumns" + _idSuffix).val(
                            $(e.target).closest("table").find("tr")[0].cells
                                .length
                        );
                        $("#tblRows" + _idSuffix).attr("disabled", "disabled");
                        $("#tblColumns" + _idSuffix).attr(
                            "disabled",
                            "disabled"
                        );
                                                ...
                                                return function () {
                                                    ...
                                                    selectedCell
                                                        ...
                                                        .each(function () {
                                                            ...
                                                            var newCell = $(
                                                                "<" +
                                                                    cellInSelectedColumn.prop(
                                                                        "nodeName"
                                                                    ) +
                                                                    "/>"
                                                            ).html("&nbsp;");
                                                            cellInSelectedColumn.after(
                                                                newCell
                                                            );
                                                        });
                                                };
        ...
        createMenuItem: function (itemSettings, options, returnElement) {
            ...
            if (itemSettings["custom"]) {
                ...
                menuWrapElement.data(
                    "commandName",
                    itemSettings["commandname"]
                );
