...
@section("title", "Kelola Halaman Penghargaan")
@section("content")
    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header pb-0">
          <h5>Kelola Penghargaan</h5>
          <span>Kelola penghargaan Dinas Pendidikan dan Kebudayaan Kota Balikpapan</span>
        </div>
        <div class="card-body">
          <form action="/dashboard/kelola-halaman/penghargaan/tambah" method="post" enctype="multipart/form-data">
            @csrf
            <hr>
            <div class="row">
              <div class="col-md-12">
                <div class="mb-3 row">
                  ...
                  <div class="col-sm-9">
                    <input class="form-control" type="text" name="nama" placeholder="Nama Penghargaan" required>
                  </div>
                </div>
                <div class="mb-3 row">
              ...
              <div class="table-responsive table-sm">
                <table class="display" id="tabel-1">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td><img class="img" height="200" src="/storage/penghargaan/{{ $dt->gambar }}" alt="{{ $dt->judul }}"></td>
                      <td>{{ $dt->nama }}</td>
                      <td>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="/dashboard/kelola-halaman/penghargaan/ubah" method="post" enctype="multipart/form-data">
          @csrf
          <div class="row">
            <div class="col-md-12">
              <div class="mb-3 row">
                <label class="col-sm-3 col-form-label">Nama<span class="text-danger">*</span></label>
                <div class="col-sm-9">
                  <input class="form-control" type="text" name="nama" placeholder="Nama Penghargaan" required value="{{ $dt->nama }}">
                </div>
              </div>
              <div class="mb-3 row">
                <label class="col-sm-3 col-form-label">Gambar<span class="text-danger">*</span></label>
...
<div class="modal fade" id="hapus-modal-{{ $dt->id }}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <form action="/dashboard/kelola-halaman/penghargaan/hapus" method="post" enctype="multipart/form-data">
          @csrf
          <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Tutup</button>
