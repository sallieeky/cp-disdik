...
@section("title", "Kelola Halaman Pojok Pintar")
@section("content")
    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header pb-0">
          <h5>Kelola Pojok Pintar</h5>
          <span>Kelola pojok pintar Dinas Pendidikan dan Kebudayaan Kota Balikpapan</span>
        </div>
        <div class="card-body">
          <form action="/dashboard/kelola-halaman/pojok-pintar/tambah" method="post" enctype="multipart/form-data">
            @csrf
            <hr>
            <div class="row">
              <div class="col-md-12">
                <div class="mb-3 row">
                  ...
                  <div class="col-sm-9">
                    <input class="form-control" type="text" name="judul" placeholder="Judul Pojok Pintar" required>
                  </div>
                </div>
                <div class="mb-3 row">
                ...
                <div class="mb-3 row">
                  ...
                  <div class="col-sm-9">
                    <textarea class="form-control" name="deskripsi" id="deskripsi" cols="30" rows="20" placeholder="Deskripsi Pojok Pintar" required></textarea>
                  </div>
                </div>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="/dashboard/kelola-halaman/pojok-pintar/ubah" method="post" enctype="multipart/form-data">
          @csrf
          <div class="row">
            <div class="col-md-12">
              <div class="mb-3 row">
                <label class="col-sm-3 col-form-label">Judul<span class="text-danger">*</span></label>
                <div class="col-sm-9">
                  <input class="form-control" type="text" name="judul" placeholder="Judul Pojok Pintar" required value="{{ $dt->judul }}">
                </div>
              </div>
              <div class="mb-3 row">
                <label class="col-sm-3 col-form-label">Gambar<span class="text-danger">*</span></label>
              ...
              <div class="mb-3 row">
                <label class="col-sm-3 col-form-label">Deskripsi<span class="text-danger">*</span></label>
                <div class="col-sm-9">
                  <textarea class="form-control" name="deskripsi" id="deskripsi" cols="30" rows="20" placeholder="Deskripsi Pojok Pintar" required>{!! str_replace('<br />', '', $dt->deskripsi) !!}</textarea>
                </div>
              </div>
            </div>
          </div>
...
<div class="modal fade" id="hapus-modal-{{ $dt->id }}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <form action="/dashboard/kelola-halaman/pojok-pintar/hapus" method="post" enctype="multipart/form-data">
          @csrf
          <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Tutup</button>
