...
@section("title", "Kelola Halaman Visi Misi dan Tujuan")
@section("css")
<link rel="stylesheet" type="text/css" href="/template-dashboard/assets/css/page-builder.css">
@endsection
@section("content")
...
@endsection
@section("script")
<script src="/template-dashboard/assets/js/editor/ckeditor/ckeditor.js"></script>
<script src="/template-dashboard/assets/js/editor/ckeditor/adapters/jquery.js"></script>
<script src="/template-dashboard/assets/js/jquery.ui.min.js"></script>
<script src="/template-dashboard/assets/js/page-builder/jquery.grideditor.min.js"></script>
<script src="/template-dashboard/assets/js/page-builder/page-builder-custom.js"></script>
@endsection