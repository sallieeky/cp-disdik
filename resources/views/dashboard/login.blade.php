...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="/template-dashboard/assets/images/favicon.png" type="image/x-icon">
    <link rel="shortcut icon" href="/template-dashboard/assets/images/favicon.png" type="image/x-icon">
